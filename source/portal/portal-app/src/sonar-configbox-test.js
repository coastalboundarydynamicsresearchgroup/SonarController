        ...
        <div className="configurationbox">
          <div className="configurationgroup">
            ...
            <div className="configurationrow">
              <SonarConfigField fieldname="minutes" fieldTitle="TEST Minutes after hour" initialValue="5" onChangeFunc={onChangeFunc}></SonarConfigField>
              <SonarConfigField fieldname="pencilbeamcount" fieldTitle="TEST Pencil Beam Images to Average" initialValue="1" onChangeFunc={onChangeFunc}></SonarConfigField>
            ...
            <div className="configurationrow">
              <SonarConfigField fieldname="serialsendchoice" fieldTitle="TEST Serial Send Choice" initialValue="0" onChangeFunc={onChangeFunc}></SonarConfigField>
              <SonarConfigField fieldname="azimuthincrement" fieldTitle="TEST Azimuth Increment in degrees" initialValue="2.40000" onChangeFunc={onChangeFunc}></SonarConfigField>
          ...
          <div className="configurationgroup">
            Downward
            <div className="configurationrow">
              <SonarConfigField fieldname="downwardpencilbeamrange" fieldTitle="TEST Pencil Beam Range" initialValue="4" onChangeFunc={onChangeFunc}></SonarConfigField>
              <SonarConfigField fieldname="downwardfrequency" fieldTitle="TEST Frequency" initialValue="165" onChangeFunc={onChangeFunc}></SonarConfigField>
