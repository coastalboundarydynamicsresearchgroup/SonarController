...
#print('range: ' + str(range) + ' gain: ' + str(gain) + ' logf: ' + str(logf) + ' absorption: ' + str(absorption) + ' pulse_length: ' + str(pulse_length) + ' data_points: ' + str(data_points) + ' profile: ' + str(profile) + ' frequncy: ' + str(frequency))

sonar = SonarCommChannel()
command = sonar.create_switch_command(range=range, 
                                      gain=gain, 
                                      logf=logf, 
...
with sonar:
  ...
  # TODO - Write raw data to file, process and return as JSON.
